    ...
    return (
        <section className="pt-5 md:pt-16 max-w-7xl mx-auto px-5 dark:bg-gray-100 dark:text-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div data-aos="fade-down" data-aos-duration="500" className="radial-progress text-[#FF4240] mb-2" style={{"--value":70, "--size": "8rem"}} role="progressbar">70%</  div>
                ...
                <div className="flex flex-col items-center p-4">
                <div data-aos="fade-down" data-aos-duration="500" data-aos-delay="100" className="radial-progress text-[#49D293] mb-2" style={{"--value":60, "--size": "8rem"}} role="progressbar">60%</  div>
                ...
                <div className="flex flex-col items-center p-4">
                <div data-aos="fade-down" data-aos-duration="500"  data-aos-delay="200"className="radial-progress text-[#FFB546] mb-2" style={{"--value":90, "--size": "8rem"}} role="progressbar">90%</  div>
                ...
                <div className="flex flex-col items-center p-4">
                <div data-aos="fade-down" data-aos-duration="500"  data-aos-delay="300"className="radial-progress text-[#4C8DF1] mb-2" style={{"--value":80, "--size": "8rem"}} role="progressbar">80%</  div>
